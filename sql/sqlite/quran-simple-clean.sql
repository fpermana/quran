...
--
-- Table structure for table `quran_text_clean`
--

DROP TABLE IF EXISTS `quran_text_clean`;
CREATE TABLE `quran_text_clean` (
...
--
-- Dumping data for table `quran_text_clean`
--

-- Sura 1 (الفاتحة)
INSERT INTO `quran_text_clean` (`id`, `sura`, `aya`, `text`) VALUES
